...
Config.DisableControls = {
	Mouse = true, -- Disable mouse controls until progress is complete
	Player = true, -- Disable player movement until progress is complete
	Vehicle = true, -- Disable vehicle control until progress is complete
}
