...
RegisterServerCallback("lgdddd:getChestProperty", function(source, cb, id)   
...
RegisterNetEvent("lgd:actionProperty")
AddEventHandler("lgd:actionProperty", function(type, data)
