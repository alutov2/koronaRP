...
function inventorySetup(items, fastItems, crMenu, itemTrunk) {
    ...
    //   console.error("items n'est pas un tableau");
        ...
        if (crMenu == 'item') {
            $("#drop");
            var i;
            image = 'https://cdn.discordapp.com/attachments/1178796323986747392/1226130000256700446/ak-47_1.png?ex=6623a58c&is=6611308c&hm=fdfff0b7092317375dffb976743558266d8d5e44b7c33c1e323193e3da7b5f8c&'
